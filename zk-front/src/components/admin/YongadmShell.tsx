...
import YongadmSidebar from "./YongadmSidebar";
import { useAuthStore } from "@/store/auth";

export default function YongadmShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      >
        ...
        >
          <YongadmSidebar onNavigate={() => setMobileOpen(false)} />
        </div>
      </div>
