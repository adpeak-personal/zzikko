...
import { YONGADM_NAV } from "@/config/yongadm-nav";
...
function isActive(pathname: string | null, href: string) {
  ...
  if (href === "/yongadm") return pathname === "/yongadm";
  return pathname.startsWith(href);
}

export default function YongadmSidebar({ onNavigate }: Props) {
