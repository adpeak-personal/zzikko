...
import nblogTitlesRoutes from './routes/nblog-titles';
import blogJobsRoutes from './routes/blog-jobs';
import nblogJobsRoutes from './routes/nblog-jobs';
...
app.register(nblogTitlesRoutes, { prefix: '/api/ai' });
app.register(blogJobsRoutes, { prefix: '/api/blog-jobs' });
app.register(nblogJobsRoutes, { prefix: '/api/nblog-jobs' });
